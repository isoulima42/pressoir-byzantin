...
async function generateMetadata() {
    ...
    return {
        ...
        description: page?.seo?.metaDescription ?? "Privatisez notre salle pour vos événements ou faites appel à notre service traiteur. Anniversaires, mariages, séminaires et plus.",
        openGraph: {
            title: "Événements & Traiteur | Le Pressoir Byzantin",
            description: "Service traiteur et location de salle pour vos événements à Villeneuve.",
            images: [
                {
...
/* ── Fallback data ─────────────────────────────────────── */ const FALLBACK_CATEGORIES = [
    {
        ...
        description: "Fêtez vos moments importants dans un cadre chaleureux et authentique.",
        icon: "🎂",
        items: [
            {
                _id: "f1",
            ...
            {
                _id: "f4",
                title: "Célébrations de diplômes"
            }
        ]
    },
    {
        ...
        description: "Un cadre idéal pour vos réunions et événements d'entreprise.",
        icon: "🏢",
        items: [
            {
                _id: "f5",
    ...
    },
    {
        ...
        description: "Notre cuisine voyageuse se déplace chez vous. Menus sur mesure.",
        icon: "🍽️",
        items: [
            {
                _id: "f9",
    ...
    },
    {
        ...
        description: "Une salle au charme d'un ancien pressoir pour vos événements.",
        icon: "🏛️",
        items: []
    }
];
const FALLBACK_VENUE = {
    capacity: 60,
    features: [
        "Salle au charme d'un ancien pressoir",
        "Capacité d'accueil jusqu'à 60 personnes assises",
        "Décoration et dressage de tables inclus",
        "Installation lumière et son sur demande"
    ],
    images: [
...
const FALLBACK_ADDITIONAL = [
    {
        _id: "a1",
        title: "Animation musicale (DJ ou musiciens live)"
    },
    {
        _id: "a2",
    ...
    {
        _id: "a3",
        title: "Décoration florale personnalisée"
    },
    {
        _id: "a4",
        title: "Création de menus sur mesure"
    }
];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c4d9c911._.js.map