...
function manifest() {
    return {
        ...
        short_name: "Pressoir Byzantin",
        description: "Cuisine orientale et méditerranéenne à Villeneuve — pide, pizza, shawarma, crêpes et plus.",
        start_url: "/",
        display: "standalone",
        ...
        icons: [
            {
                src: "/images/logo/Artboard-1-120x120.png",
                sizes: "120x120",
                type: "image/png"
            },
            {
            ...
            {
                src: "/images/logo/Artboard-1-300x300.png",
                sizes: "300x300",
                type: "image/png"
            },
            {
            ...
            {
                src: "/images/logo/Artboard-1-768x768.png",
                sizes: "768x768",
                type: "image/png",
                purpose: "any"
            },
            {
                src: "/images/logo/Artboard-1-1024x1024.png",
                sizes: "1024x1024",
                type: "image/png",
                purpose: "any"
            }
